...
const Card = (props) => {
    ...
    return (
      ...
      <div className="relative overflow-hidden rounded-lg mb-6 mt-5">
        <img src="https://images.unsplash.com/photo-1755519371418-2e0737bbfc9b?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Featured content" width={400} height={300} className="object-cover object-center w-full h-48 transition-transform duration-300 group-hover:scale-110"/>
